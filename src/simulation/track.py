...
PRESET_TRACKS: Dict[str, List[Tuple[float, ...]]] = {
    ...
    # ── Giai đoạn 1: Base Skills ──
    "map_straight": [
        (100, 300, 80), (700, 300, 80)
    ],
    "map_u_turn": [
        (100, 200, 80), (600, 200, 80), 
        (700, 300, 160),  # Đỉnh cua nới rộng để tạo run-off area
        (600, 400, 80), (100, 400, 80)
    ],
    "map_zigzag": [
        (100, 100, 80), (300, 100, 80), (400, 250, 90), 
        (300, 400, 80), (500, 400, 80), (600, 250, 90), (700, 100, 80)
    ],
    
  
    # ── Giai đoạn Đặc biệt: Kết hợp City & Oval ──
    "city_oval": [
        # Đoạn thẳng tốc độ cao giống city
        (150, 150, 70), (650, 150, 70),
        # Khúc cua bo tròn mượt như oval
        (750, 250, 80), (700, 400, 80), (550, 450, 70),
        # Đoạn lượn sóng nhẹ (kink) ở giữa
        (400, 350, 70), (250, 450, 70), 
        # Khúc cua bo tròn về vạch xuất phát
        (100, 400, 80), (50, 250, 80)
    ],
    
    # ── Giai đoạn 3: Final Challenge ──
    "city_simple": [
